...
5. Your code index or `PLAN/` for prior decisions.
...
- Write curated findings - conclusions, chosen option, rejected options *with reasons*,
  affected areas - to `PLAN/<ID>_<slug>/research/<NN>__<topic-slug>.md`. Create the
  folder if missing.
...
- Ticket-bound: report the artifact path under `PLAN/`.
